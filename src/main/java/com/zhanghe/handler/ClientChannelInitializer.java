...
//        pipeline.addLast(new LengthFieldBasedFrameDecoder(Integer.MAX_VALUE, 0, ClientChannelInitializer.MESSAGE_LENGTH, 0, ClientChannelInitializer.MESSAGE_LENGTH));
//        //利用LengthFieldPrepender回填补充ObjectDecoder消息报文头
//        pipeline.addLast(new LengthFieldPrepender(ClientChannelInitializer.MESSAGE_LENGTH));
